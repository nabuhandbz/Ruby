...
module.exports = {
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '918289836232@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'RUBY BOT' : process.env.BOT_NAME,
